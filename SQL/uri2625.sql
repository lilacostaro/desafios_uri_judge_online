"""
Created on Fri Jan  7 00:30:15 2022
...
SELECT
 	substring(natural_person.cpf, 1, 3) ||'.' || substring(natural_person.cpf, 4, 3) || '.' || substring(natural_person.cpf, 7, 3) || '-' || substring(natural_person.cpf, 10, 2)
FROM customers 
